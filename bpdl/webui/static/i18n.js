...
const I18N = {
  en: {
    ...
    "fake.title": "Fake-lossless check",
    "fake.short": "Check",
    "fake.blurb": "A lossy encoder throws away everything above a cutoff frequency and cannot put it back. Re-encoding to FLAC rebuilds a lossless container around lossy audio — the extension, bitrate and file size all look right. This measures the spectrum of every file in a folder and reports the ones that were made from MP3 or AAC.",
    "fake.no_ffmpeg": "ffmpeg is not installed in this container, so audio cannot be decoded. Install ffmpeg (or the imageio-ffmpeg package) and restart.",
    "fake.folder": "Folder to check",
    "fake.recursive": "Include subfolders",
    "fake.scan": "Scan",
    "fake.stop": "Stop",
    "fake.stopping": "Stopping…",
    "fake.starting": "Looking for audio files…",
    "fake.progress": "{done} of {total} — {file}",
    "fake.done": "Scan finished — {count} file(s) analysed.",
    "fake.failed": "Scan failed: {error}",
    "fake.select_flagged": "select everything flagged",
    "fake.selected": "{count} selected",
    "fake.report": "Save report",
    "fake.export": "Save spectrograms",
    "fake.export_started": "Rendering {count} spectrogram(s) into {dir}…",
    "fake.export_progress": "Saving picture {done} of {total} — {file}",
    "fake.exported": "{count} spectrogram(s) saved to {dir}",
    "fake.export_failed": "Could not save the spectrograms: {error}",
    "fake.spec_save": "Save this picture",
    "fake.clear": "Clear results",
    "fake.clear_confirm": "Clear the {count} scanned file(s) from this list? No audio is touched and anything already quarantined stays where it is.",
    "fake.cleared": "Cleared {count} result(s).",
    "fake.restore": "Put quarantined back",
    "fake.restored": "{count} file(s) put back.",
    "fake.quarantine": "Quarantine",
    "fake.quarantined": "{count} file(s) moved to {dir}",
    "fake.delete": "Delete",
    "fake.delete_confirm": "Permanently delete {count} file(s)? This cannot be undone — quarantine instead if you are not sure.",
    "fake.deleted": "{count} file(s) deleted.",
    "fake.col_verdict": "Verdict",
    "fake.col_file": "File",
    "fake.col_track": "Track",
    "fake.delete_all": "Delete all flagged",
    "fake.col_cutoff": "Cutoff",
    "fake.col_wall": "Wall",
    "fake.col_above": "Above",
    "fake.col_why": "Why",
    "fake.empty": "Nothing scanned yet.",
    "fake.v_lossy": "lossy",
    "fake.v_padded": "padded",
    "fake.v_upsampled": "upsampled",
    "fake.v_suspect": "suspect",
    "fake.v_clean": "clean",
    "fake.v_unreadable": "unreadable",
    "fake.v_lossy_format": "lossy format",
    "fake.spectrogram": "Show spectrogram",
    "fake.spec_loading": "Rendering spectrogram…",
    "fake.spec_failed": "Could not render this file's spectrogram.",
    "fake.spec_nums": "cutoff {cutoff} kHz · wall {wall} dB · above {above} dB",
    "fake.spec_hint": "A lossy ancestor shows as a dead band with a razor-straight edge across the top. A genuine master fades out unevenly and keeps noise all the way to the top of the picture.",
  ...
  es: {
    ...
    "fake.title": "Detector de lossless falso",
    "fake.short": "Verificar",
    "fake.blurb": "Un codificador con pérdida descarta todo lo que hay por encima de una frecuencia de corte y no puede devolverlo. Al recodificar a FLAC se construye un contenedor sin pérdida alrededor de audio con pérdida: la extensión, el bitrate y el tamaño parecen correctos. Esto mide el espectro de cada archivo de una carpeta y señala los que salieron de un MP3 o un AAC.",
    "fake.no_ffmpeg": "ffmpeg no está instalado en este contenedor, así que no se puede descodificar el audio. Instala ffmpeg (o el paquete imageio-ffmpeg) y reinicia.",
    "fake.folder": "Carpeta a revisar",
    "fake.recursive": "Incluir subcarpetas",
    "fake.scan": "Analizar",
    "fake.stop": "Parar",
    "fake.stopping": "Parando…",
    "fake.starting": "Buscando archivos de audio…",
    "fake.progress": "{done} de {total} — {file}",
    "fake.done": "Análisis terminado — {count} archivo(s) analizado(s).",
    "fake.failed": "Fallo al analizar: {error}",
    "fake.select_flagged": "seleccionar todo lo señalado",
    "fake.selected": "{count} seleccionado(s)",
    "fake.report": "Guardar informe",
    "fake.export": "Guardar espectrogramas",
    "fake.export_started": "Generando {count} espectrograma(s) en {dir}…",
    "fake.export_progress": "Guardando imagen {done} de {total} — {file}",
    "fake.exported": "{count} espectrograma(s) guardado(s) en {dir}",
    "fake.export_failed": "No se han podido guardar los espectrogramas: {error}",
    "fake.spec_save": "Guardar esta imagen",
    "fake.clear": "Vaciar resultados",
    "fake.clear_confirm": "¿Quitar de la lista los {count} archivo(s) analizados? No se toca ningún audio y lo ya aislado se queda donde está.",
    "fake.cleared": "{count} resultado(s) borrado(s) de la lista.",
    "fake.restore": "Devolver los aislados",
    "fake.restored": "{count} archivo(s) devuelto(s).",
    "fake.quarantine": "Aislar",
    "fake.quarantined": "{count} archivo(s) movido(s) a {dir}",
    "fake.delete": "Borrar",
    "fake.delete_confirm": "¿Borrar {count} archivo(s) para siempre? No se puede deshacer — aíslalos si no estás seguro.",
    "fake.deleted": "{count} archivo(s) borrado(s).",
    "fake.col_verdict": "Veredicto",
    "fake.col_file": "Archivo",
    "fake.col_track": "Pista",
    "fake.delete_all": "Borrar todos los señalados",
    "fake.col_cutoff": "Corte",
    "fake.col_wall": "Muro",
    "fake.col_above": "Encima",
    "fake.col_why": "Motivo",
    "fake.empty": "Todavía no se ha analizado nada.",
    "fake.v_lossy": "con pérdida",
    "fake.v_padded": "rellenado",
    "fake.v_upsampled": "remuestreado",
    "fake.v_suspect": "sospechoso",
    "fake.v_clean": "limpio",
    "fake.v_unreadable": "ilegible",
    "fake.v_lossy_format": "formato con pérdida",
    "fake.spectrogram": "Ver espectrograma",
    "fake.spec_loading": "Generando el espectrograma…",
    "fake.spec_failed": "No se ha podido generar el espectrograma de este archivo.",
    "fake.spec_nums": "corte {cutoff} kHz · muro {wall} dB · encima {above} dB",
    "fake.spec_hint": "Un origen con pérdida aparece como una banda muerta con un borde recto como una cuchilla en la parte de arriba. Un máster auténtico se apaga de forma irregular y conserva ruido hasta lo más alto de la imagen.",
  ...
  nl: {
    ...
    "fake.title": "Nep-lossless controle",
    "fake.short": "Controle",
    "fake.blurb": "Een lossy encoder gooit alles boven een afkapfrequentie weg en kan dat niet terugzetten. Opnieuw coderen naar FLAC bouwt een lossless verpakking om lossy audio heen — de extensie, de bitrate en de bestandsgrootte kloppen allemaal. Dit meet het spectrum van elk bestand in een map en meldt welke uit een MP3 of AAC komen.",
    "fake.no_ffmpeg": "ffmpeg is niet geïnstalleerd in deze container, dus audio kan niet gedecodeerd worden. Installeer ffmpeg (of het pakket imageio-ffmpeg) en herstart.",
    "fake.folder": "Map om te controleren",
    "fake.recursive": "Inclusief submappen",
    "fake.scan": "Scannen",
    "fake.stop": "Stoppen",
    "fake.stopping": "Stoppen…",
    "fake.starting": "Zoeken naar audiobestanden…",
    "fake.progress": "{done} van {total} — {file}",
    "fake.done": "Scan klaar — {count} bestand(en) geanalyseerd.",
    "fake.failed": "Scan mislukt: {error}",
    "fake.select_flagged": "alles met een melding selecteren",
    "fake.selected": "{count} geselecteerd",
    "fake.report": "Rapport opslaan",
    "fake.export": "Spectrogrammen opslaan",
    "fake.export_started": "{count} spectrogram(men) maken in {dir}…",
    "fake.export_progress": "Afbeelding {done} van {total} opslaan — {file}",
    "fake.exported": "{count} spectrogram(men) opgeslagen in {dir}",
    "fake.export_failed": "Kon de spectrogrammen niet opslaan: {error}",
    "fake.spec_save": "Deze afbeelding opslaan",
    "fake.clear": "Resultaten wissen",
    "fake.clear_confirm": "De {count} gescande bestand(en) uit deze lijst halen? Er wordt geen audio aangeraakt en wat al in quarantaine staat blijft staan.",
    "fake.cleared": "{count} resulta(a)t(en) uit de lijst gehaald.",
    "fake.restore": "Quarantaine terugzetten",
    "fake.restored": "{count} bestand(en) teruggezet.",
    "fake.quarantine": "Quarantaine",
    "fake.quarantined": "{count} bestand(en) verplaatst naar {dir}",
    "fake.delete": "Verwijderen",
    "fake.delete_confirm": "{count} bestand(en) definitief verwijderen? Dit kan niet ongedaan gemaakt worden — zet ze in quarantaine als je twijfelt.",
    "fake.deleted": "{count} bestand(en) verwijderd.",
    "fake.col_verdict": "Oordeel",
    "fake.col_file": "Bestand",
    "fake.col_track": "Nummer",
    "fake.delete_all": "Alle gemelde verwijderen",
    "fake.col_cutoff": "Afkap",
    "fake.col_wall": "Muur",
    "fake.col_above": "Erboven",
    "fake.col_why": "Reden",
    "fake.empty": "Nog niets gescand.",
    "fake.v_lossy": "verliesgevend",
    "fake.v_padded": "opgevuld",
    "fake.v_upsampled": "opgeschaald",
    "fake.v_suspect": "verdacht",
    "fake.v_clean": "schoon",
    "fake.v_unreadable": "onleesbaar",
    "fake.v_lossy_format": "lossy formaat",
    "fake.spectrogram": "Spectrogram tonen",
    "fake.spec_loading": "Spectrogram maken…",
    "fake.spec_failed": "Kon het spectrogram van dit bestand niet maken.",
    "fake.spec_nums": "afkap {cutoff} kHz · muur {wall} dB · erboven {above} dB",
    "fake.spec_hint": "Een lossy herkomst laat zich zien als een dode band met een kaarsrechte rand over de bovenkant. Een echte master dooft onregelmatig uit en houdt ruis tot helemaal boven in het beeld.",
